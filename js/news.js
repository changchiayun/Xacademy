...
collection.fetch({
  success: function(collection){
    collection.each(function(object){
      ...
      $(".newsroom").append("<div class='span3'><img class='img-circle' src="+object.get("photo")+"><h5 id="+object.id+">"+object.get("datepicker")+"</h5><h4 id="+object.id+">"+object.get("title")+"</h4><div>");
